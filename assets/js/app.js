...
sr.reveal('.section-title-container', { origin: 'top', interval: 250 });
sr.reveal('.section-title', { origin: 'top', interval: 250 });
sr.reveal('.portfolio-card', { interval: 500 });
sr.reveal('.form-container', { origin: 'top' });
sr.reveal('.footer', { origin: 'top' });

sr.reveal('.list-item', { interval: 250, origin: 'bottom' });